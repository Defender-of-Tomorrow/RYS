...
face_cascade = cv.CascadeClassifier("haarcascade_frontalface_alt2.xml")  # 정면 검출기
eye_cascade = cv.CascadeClassifier("haarcascade_eye.xml")  # 눈 검출기
